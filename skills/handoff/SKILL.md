...
Write a handoff document summarising the current conversation so a fresh agent can continue the work. Save to ~/Downloads/ — use a descriptive filename like handoff-TICKETID.md or handoff-topic.md.
