...
Kill empty adverbs: softeners, intensifiers, hedges. Keep adverbs that carry
information — "stored **locally**", "clear it **manually**", "wiped
**automatically**" all state a fact the sentence loses without them. Test: drop
the word. If the meaning survives, cut it; if the reader now has to guess, keep
it, and never swap it for a folksier phrase ("by hand" for "manually").
